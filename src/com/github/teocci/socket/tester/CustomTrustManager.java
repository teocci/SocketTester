package com.github.teocci.socket.tester;
...
/**
 * Custom CustomTrustManager
 *
 * @author Benjamin Fleckenstein (Thanks Ben for your email)
 * @author Akshathkumar Shetty
 * @author Jorge Frisancho teocci@yandex.com
 */
public class CustomTrustManager implements X509TrustManager
{
    ...
    public CustomTrustManager(Component parentComponent) throws Exception
    {
            ...
            throws CertificateException
    {
        try {
            ...
            for (int i = 0; i < chain.length; i++) {
                if (i == 0) {
                    buffer.append("Do you want to trust this server? \n\n");
                    buffer.append("Server Certificate:\n\t").append(chain[i].getSubjectDN());
                } else {
                    buffer.append("\n Issued By:\n\t").append(chain[i].getSubjectDN());
                }
            }
            ...
            int option = JOptionPane.showConfirmDialog(parentComponent,
                    buffer.toString(), "Certificate Confirmation",
