...
import com.github.teocci.socket.tester.nio.UdpServer;
 ...
 */
public class UdpTest extends JPanel
{
    private final String NEW_LINE = "\r\n";
    private ClassLoader cl = getClass().getClassLoader();
    public ImageIcon logo = new ImageIcon(cl.getResource("icons/logo.png"));
    ...
    private JLabel logoLabel = new JLabel("SocketTester v 3.0", logo, JLabel.CENTER);
    ...
    public UdpTest(final JFrame parent)
    {
        ...
        ActionListener ipListener1 = e -> portField1.requestFocus();
        ...
        gbc.gridwidth = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        ActionListener connectListener = e -> listen();
        ...
        gbc.gridwidth = 1;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        ActionListener ipListener2 = e -> portField2.requestFocus();
        ...
        gbc.gridwidth = 1;
        gbc.fill = GridBagConstraints.NONE;
        ActionListener portListener2 = e -> sendField.requestFocus();
        ...
        clientPanel.setBorder(new CompoundBorder(
        ...
        ActionListener saveListener = e -> {
            ...
            int returnVal = chooser.showSaveDialog(UdpTest.this);
    ...
    private void listen()
    {
        ...
        int portNo = Util.validateAddressAndPort(this, ipField1, portField1);
        ...
        append("> ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        udpServer = UdpServer.handleServer(this, server);
    }
    ...
    public void sendMessage(String s)
    {
        try {
            ...
            int portNo = Util.validateAddressAndPort(this, ipField2, portField2);
            ...
            buffer = s.getBytes();
            pack = new DatagramPacket(buffer, buffer.length, destination, portNo);
            append("S[" + destination.getHostAddress() + ":" + portNo + "]: " + s);
            client.send(pack);
            sendField.setText("");
            setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(UdpTest.this,
