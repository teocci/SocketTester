...
public class About extends JPanel
{
    ...
    public ImageIcon ball = new ImageIcon(cl.getResource("icons/ball.png"));

    private JPanel centerPanel;
    private JPanel topPanel;

    private JLabel productName = new JLabel("<html><font face=\"verdana\" size=8>SocketTester", logo, JLabel.CENTER);
    private JTextArea readme = new JTextArea();
    private JScrollPane jsp;

    String html = "<html><font face=\"verdana\" size=\"3\">";

    private JLabel versionText = new JLabel(html + "Version", ball, JLabel.LEFT);
    private JLabel version = new JLabel(html + ": 1.0.3", JLabel.LEFT);

    private JLabel licenceText = new JLabel(html + "Licence", ball, JLabel.LEFT);
    private JLabel licence = new JLabel(html + ": MIT License", JLabel.LEFT);

    private JLabel authorText = new JLabel(html + "Author", ball, JLabel.LEFT);
    private JLabel author = new JLabel(html + ": Jorge Frisancho", JLabel.LEFT);

    private JLabel copyrightText = new JLabel(html + "Copyright &copy; 2017 Jorge Frisancho", ball, JLabel.LEFT);

    private JLabel websiteText = new JLabel(html + "Website", ball, JLabel.LEFT);
    private JLabel website = new JLabel(html + ": https://github.com/teocci/SocketTester", JLabel.LEFT);
    ...
    public About()
    {
        ...
        try {
            String cont = Util.readFile("ABOUT", About.this);
            readme.setText(cont);
        } catch (IOException e) {
            System.err.println("Error reading ABOUT file " + e);
            readme.append("\r\nFailed : " + e.getMessage());
        }
